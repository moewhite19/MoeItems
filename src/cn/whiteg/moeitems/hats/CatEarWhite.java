...
public class CatEarWhite extends CustItem_CustModle {
    ...
    public ItemStack createItem() {
        ...
        im.addAttributeModifier(Attribute.GENERIC_ATTACK_SPEED,new AttributeModifier(UUID.randomUUID(),"",0.01,AttributeModifier.Operation.ADD_NUMBER,EquipmentSlot.HEAD));
        item.setItemMeta(im);
        return item;
    }
}
